...
to the caller;  by default, such errors cause the running initForCallback to exit. */
...
int WINAPI DllMain(HINSTANCE hInstance, DWORD fdwReason, PVOID pvReserved)
{
	...
	break;
	/* when initForCallback terminates, always close WFDB files before shutdown or
	   when the last WFDB application exits */
